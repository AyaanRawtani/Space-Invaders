...
namespace UI
{
	namespace UIElement
	{
        ...
        void AnimatedImageView::registerCallbackFunction(CallbackFuntion animation_end_callback)
        {
        ...
        void AnimatedImageView::playAnimation(AnimationType type, float duration, CallbackFuntion animation_end_callback)
        {
            ImageView::show();
            reset();
